  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p className="text-center max-w-2xl mx-auto mb-16 text-gray-700 font-body" variants={itemVariants}>
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="text-black group-hover:text-blue-400 transition-colors duration-300 relative z-10 scale-110">
            {icon}
          </div>
          
          {/* Decorative corner icon */}
          <div className="absolute -top-1 -right-1 opacity-40 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300">
            {secondaryIcon}
          </div>
        </motion.div>
        <h3 className="text-2xl font-display font-semibold text-black group-hover:text-blue-400 transition-colors duration-300 tracking-tight">
          {title}
        </h3>
      </motion.div>
      <motion.p
        className="text-base text-gray-700 font-body leading-relaxed pl-16 group-hover:text-gray-600 transition-colors duration-300"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
function StatCounter({ icon, value, label, suffix, delay }) {
  ...
  return (
    <motion.div
      className="flex flex-col items-center justify-center relative p-8 bg-gray-50 rounded-3xl border border-gray-200 group hover:bg-gray-100 hover:shadow-2xl hover:shadow-blue-400/10 transition-all duration-500"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: false }}
    >
      ...
      <motion.div 
        className="w-12 h-12 flex items-center justify-center rounded-2xl bg-blue-400/20 text-black mb-6 group-hover:scale-110 transition-transform duration-500"
        variants={{
